...
int main() {
     ...
     */
    fd_origem = open("/workspaces/SISOP-2025-chamada-de-sistema/dados/origem.txt", O_RDONLY);;
     ...
     * Permissões: 0644
     */
    fd_destino = open("/workspaces/SISOP-2025-chamada-de-sistema/dados/destino.txt", O_WRONLY | O_CREAT | O_TRUNC, 0644);;
